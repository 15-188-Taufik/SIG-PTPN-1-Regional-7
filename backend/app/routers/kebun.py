            ...
            try:
                ...
                for feat in data.get("features", []):
                    ...
                    norm_props = {
                        ...
                        "nomor_peta": props.get("Nomor_Peta") or props.get("nomor_peta"),
                    }
...
def _blok_to_feature(blok: BlokKebun, geom_json: str) -> dict:
    ...
    props = dict(blok.properties) if blok.properties else {}
    props.update({
        "id": blok.id,
        "kebun": blok.kebun,
        "kode_blok": blok.kode_blok,
        "no_polygon": blok.no_polygon,
        "no_aset": blok.no_aset,
