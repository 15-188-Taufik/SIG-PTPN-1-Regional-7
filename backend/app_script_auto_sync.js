/**
 * Google Apps Script - SIG PTPN Real-Time Auto-Sync (v3.2 - Installable Trigger)
 * 
  ...
  for (var i = 0; i < numRows; i++) {
    ...
    if (isInsert) {
      if (!rowData["tanggal"]) {
        ...
        // PERBAIKAN: validasi menggunakan id_blok / kode_blok menggantikan id_afdeling
        var hasBlok = rowData["id_blok"] || rowData["blok_id"] || rowData["kode_blok"];
